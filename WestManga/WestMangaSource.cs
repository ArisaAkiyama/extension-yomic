...
namespace Yomic.Extensions.WestManga
{
    public class WestMangaSource : HttpSource, IFilterableMangaSource
    {
        ...
        public override string BaseUrl => "https://westmanga.co";
        public override string Language => "ID";
        public override bool IsHasMorePages => true;

        public override string Version => "1.0.1";
        public override string IconUrl => "https://www.google.com/s2/favicons?domain=westmanga.co&sz=128";
        ...
        private const string ApiBase = "https://data.mantweh.online/api";
        ...
        {
            client.DefaultRequestHeaders.Add("Origin", "https://westmanga.co");
            client.DefaultRequestHeaders.Referrer = new Uri("https://westmanga.co/");
            ...
            try
            {
                ...
                if (result?.Data?.Chapters != null)
                {
                    foreach (var ch in result.Data.Chapters)
                    {
                        ...
                        {
                            // API usually returns timestamp in seconds, Yomic expects milliseconds
                            chapter.DateUpload = ch.UpdatedAt.Time < 10000000000 ? ch.UpdatedAt.Time * 1000 : ch.UpdatedAt.Time;
                        }
                        else
                        {

...
namespace Yomic.Extensions.KomikStation
{
    public class KomikStationSource : HttpSource, IFilterableMangaSource
    {
        public override string Name => "KomikStation";
        public override string BaseUrl => "https://komikstation.org";
        public override string Language => "ID";
        public override bool IsHasMorePages => true;

        public override string Version => "1.0.0";
        public override string IconUrl => "https://www.google.com/s2/favicons?domain=komikstation.org&sz=128";
        public override string Description => "Baca Komik Manga Manhua Manhwa Bahasa Indonesia di KomikStation";
        ...
        {
            client.DefaultRequestHeaders.Referrer = new Uri("https://komikstation.org/");
        }
        ...
        {
            Console.WriteLine($"[KomikStation] GET {url}");
        ...
        public override async Task<Manga> GetMangaDetailsAsync(string mangaId)
        {
            ...
            string url = $"{BaseUrl}{MangaUrlDirectory}/{slug}/";
        ...
        public override async Task<List<Chapter>> GetChapterListAsync(string mangaId)
        {
            ...
            {
                Console.WriteLine($"[KomikStation] GetChapterListAsync error: {ex.Message}");
            }
        ...
        public override async Task<List<string>> GetPageListAsync(string chapterUrl)
        {
            ...
            try
            {
                ...
                // Strategy 2: If no images found in HTML, try JSON from ts_reader.run script
                if (pages.Count == 0)
                {
                    ...
                    if (jsonMatch.Success)
                    {
                        ...
                        {
                            Console.WriteLine($"[KomikStation] ts_reader JSON parse error: {jsonEx.Message}");
                        }
                    }
                }
            }
            ...
            {
                Console.WriteLine($"[KomikStation] GetPageListAsync error: {ex.Message}");
            }
        ...
        /// <summary>
        /// Scrape manga list from /manga/ pages.
        ...
        private async Task<(List<Manga> Items, int TotalPages)> ScrapeMangaList(string url)
        {
            ...
            try
            {
                ...
                // Fallback: check for .next button presence
                if (totalPages == 999)
                {
                    ...
                    if (nextPage == null && list.Count > 0)
                        totalPages = 1; // No next page, single page result
                }
            }
            catch (Exception ex)
            {
                Console.WriteLine($"[KomikStation] ScrapeMangaList error: {ex.Message}");
            }
        ...
        /// <summary>
        /// Parse Indonesian date strings like "Februari 13, 2026" or "13 Februari 2026"
        /// </summary>
        private static long ParseIndonesianDate(string dateStr)
        {
            try
            {
                ...
                if (parts.Length >= 3)
                {
                    // Try format: "Februari 13 2026" (month day year)
                    ...
                    // Try format: "13 Februari 2026" (day month year)
